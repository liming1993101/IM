...
public class RecentChatAdapter extends BaseAdapter {
	...
	public LinkedList<RecentChatEntity> getList() {
		return list;
	}

	public void setList(LinkedList<RecentChatEntity> list) {
		this.list = list;
	}
	...
	public RecentChatAdapter(MyApplication context, LinkedList<RecentChatEntity> list) {
	...
	public RecentChatAdapter(Context applicationContext, LinkedList<RecentChatEntity> mRecentList) {
